...
async 季节剩余(e) {
  let 季节指定时间 = new Date('2023-10-11 12:00:00').getTime();
  let msg = '';
...
async 活动剩余(e) {
  let 活动指定时间 = new Date('2023-8-23 23:59:59').getTime();
  let msg = '';
