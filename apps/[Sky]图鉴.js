...
const SEARCH_PATTERNS = [
  /^(#|\/)?((?:季节|好友树|复刻|晨岛|云野|雨林|峡谷|霞谷|暮土|禁阁|AURORA|表演|风行|感恩|归(?:巢|属)|九色鹿|梦想|魔法|破晓|潜海|圣岛|拾光|小王子|夜行|音韵|预言|重组|追(?:光|忆)|欧若拉|集结|凌冬|筑巢|二重奏|姆明|彩染)(?:季)?兑换图)$/i,
  ...
  constructor() {
    super({
      ...
      rule: [
        ...
        { reg: /^(#|\/)?((全部)|((20|21|22|23|24|25)年))复刻记录$/i, fnc: 'regressionRecords' }
      ]
    })
