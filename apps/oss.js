...
export class oss extends plugin {
    ...
    async oss() {
        ...
        USER_FILE_DIRECTORY.forEach((FILE_NAME) => {
            ...
            const New_USER_DATA = {
                ID: USER_ID,
                昵称: (USER_DATA['昵称'] || null),
                头像: (USER_DATA['头像'] || 114514),
                最后签到日期: (USER_DATA['最后签到日期'] || null),
                连续签到天数: (USER_DATA['连续签到天数'] || 0),
                累计签到天数: (USER_DATA['累计签到天数'] || 0),
                能量值: (USER_DATA['能量值'] || 0),
                等级: (USER_DATA['等级'] || 0),
                白蜡: (USER_DATA['白蜡'] || 0),
                季蜡: (USER_DATA['季蜡'] || 0),
                代币: (USER_DATA['代币'] || 0),
                抢蜡烛次数: (USER_DATA['抢蜡烛次数'] || 0),
                被抢次数: (USER_DATA['被抢次数'] || 0),
                抢蜡烛总数: (USER_DATA['抢蜡烛总数'] || 0),
                被抢蜡烛总数: (USER_DATA['被抢蜡烛总数'] || 0),
                上次抢蜡烛时间戳: (USER_DATA['上次抢蜡烛时间戳'] || 0),
                胜: (USER_DATA['胜'] || 0),
                负: (USER_DATA['负'] || 0),
                平: (USER_DATA['平'] || 0),
                赚取: (USER_DATA['赚取'] || 0),
                亏损: (USER_DATA['亏损'] || 0),
                总赠送数量: (USER_DATA['总赠送数量'] || 0),
                总收入数量: (USER_DATA['总收入数量'] || 0),
                背包: {
                    蜡烛保护卡: (USER_DATA['蜡烛保护卡'] || 0),
                    签到双倍卡: (USER_DATA['签到双倍卡'] || 0),
                }
            }
